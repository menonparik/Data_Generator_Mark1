...
export class AutoComponent implements OnInit {
  ...
  generate() {
    ...
    for (let i = name.length - 1; i > 0; i--) {
      ...
      [company[i], company[j]] = [company[j], company[i]];
      [ratingplan[i], ratingplan[j]] = [ratingplan[j], ratingplan[i]];
      [effectiveDate[i], effectiveDate[j]] = [effectiveDate[j], effectiveDate[i]];
      [defaultStateTerritory[i], defaultStateTerritory[j]] = [defaultStateTerritory[j], defaultStateTerritory[i]];
      [city[i], city[j]] = [city[j], city[i]];
      [years[i], years[j]] = [years[j], years[i]];
      [make[i], make[j]] = [make[j], make[i]];
      [siccode[i], siccode[j]] = [siccode[j], siccode[i]];
      [zipcode[i], zipcode[j]] = [zipcode[j], zipcode[i]];
      [county[i], county[j]] = [
        county[j],
        county[i],
      ];
      [dateOfLoss[i], dateOfLoss[j]] = [dateOfLoss[j], dateOfLoss[i]];
      [legalStatus[i], legalStatus[j]] = [
        legalStatus[j],
        legalStatus[i],
      ];
      [expiryDate[i], expiryDate[j]] = [expiryDate[j], expiryDate[i]];
    }
    const shuffledData = {
      name,
      address,
    ...
    console.log(shuffledData['company'][1]);
    ...
    if (this.rowCount >= 1) {
      ...
      for (let j = 0; j < this.rowCount; j++) {
        ...
        for (let i = 0; i < this.savedData.length; i++) {
          ...
          if (this.savedData[i].value == 'company') {
            this.objectArray1.push(shuffledData['company'][index]);
          }
          if (this.savedData[i].value == 'ratingplan') {
            this.objectArray1.push(shuffledData['ratingplan'][index]);
          }
          if (this.savedData[i].value == 'effectiveDate') {
            this.objectArray1.push(shuffledData['effectiveDate'][index]);
          }
          if (this.savedData[i].value == 'expiryDate') {
            this.objectArray1.push(shuffledData['expiryDate'][index]);
          }
          if (this.savedData[i].value == 'defaultStateTerritory') {
            this.objectArray1.push(shuffledData['defaultStateTerritory'][index]);
          }
          if (this.savedData[i].value == 'city') {
            this.objectArray1.push(shuffledData['city'][index]);
          }
          if (this.savedData[i].value == 'years') {
            this.objectArray1.push(shuffledData['years'][index]);
          }
          if (this.savedData[i].value == 'make') {
            this.objectArray1.push(shuffledData['make'][index]);
          }
          if (this.savedData[i].value == 'siccode') {
            this.objectArray1.push(shuffledData['siccode'][index]);
          }
          if (this.savedData[i].value == 'zipcode') {
            this.objectArray1.push(shuffledData['zipcode'][index]);
          }
          if (this.savedData[i].value == 'county') {
            this.objectArray1.push(shuffledData['county'][index]);
          }
          if (this.savedData[i].value == 'dateOfLoss') {
            this.objectArray1.push(shuffledData['dateOfLoss'][index]);
          }
          if (this.savedData[i].value == 'legalStatus') {
            this.objectArray1.push(shuffledData['legalStatus'][index]);
          }
